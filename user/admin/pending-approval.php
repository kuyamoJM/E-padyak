<?php 
    $page = 'User Management - Pending Approval';
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php 
                  $qc = $conn->query("select * from tbl_user u inner join tbl_barangay b on b.barangay_id = u.barangay_id inner join tbl_town t on t.town_id = b.town_id where u.is_approved = 0 order by u.lname asc");
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $(".action").click(function(){
          ...
          $("#btn_confirm").attr("href", 'user-action.php?id=' + $(this).data('id') + "&back=pending-approval.php&action=" + $(this).data('action'));
      });
  });
