            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php 
                  $qc = $conn->query("select * from tbl_category where is_deleted = 0 order by category asc");
                  while ($rc = $qc->fetch_assoc()){ ?>
                    ...
                    <button type="button" class="btn btn-info btn-xs edit" data-id="<?php echo $rc['category_id']; ?>" data-toggle="modal" data-target="#update"><i class="fa fa-pencil-alt"></i> 
                    </button>
                    <button type="button" class="btn btn-danger btn-xs delete" data-question="Are you sure you want to delete <?php echo $rc['category']; ?>?" data-id="<?php echo $rc['category_id']; ?>" data-toggle="modal" data-target="#confirmModal" ><i class="fa fa-trash"></i></button>
                    </td>
                    </tr>
                    <?php } ?>
                  </tbody>
                  ...
                  <div class="modal fade" id="add">
                        <div class="modal-dialog">
                          <form action="ajax/category-record.php" method="post" id="form_submit" >
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" required="required" name="category" class="form-control" id="category" autocomplete="off" />
                                </div>
                      ...
                      <div class="modal fade" id="update">
                        <div class="modal-dialog">
                          <form action="ajax/category-save.php" method="post" id="e_form_submit" >
                          <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="e_category" class="form-control" id="e_category"  autocomplete="off"  />
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $(".edit").click(function(){
        $.ajax({
              ...
              success: function(response){
                  $("#e_category_id").val(response.category_id)
                  $("#e_category").val(response.category);
                }
            });
      });
      ...
      $(".delete").click(function(){
          ...
          $("#btn_confirm").attr("href", 'category-delete.php?id=' + $(this).data('id'));
      });
  });
