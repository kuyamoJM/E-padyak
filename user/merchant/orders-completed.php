            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php 
                  $qc = $conn->query("select * from tbl_order o left join tbl_mode_of_payment m on o.mode_of_payment_id = m.mode_of_payment_id inner join tbl_user u on u.user_id = o.user_id where o.order_id in (select order_id from tbl_product_order where product_id in (select product_id from tbl_product where store_id = '$store_id')) and o.status = 'Completed'") or die($conn->error);
                  while ($rc = $qc->fetch_assoc()){ 
                    ...
                    <tr>
                      ...
                      <a href="return-replace-items.php?order=<?php echo $rc['order_number']; ?>" class="btn btn-sm btn-success" title="Return/Replace Items"><i class="fa fa-exchange"></i></a>
