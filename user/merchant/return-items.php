        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="return-items-record.php?order=<?php echo $ro['order_number']; ?>" method="post" id="form_submit" >
                    ...
                    <div class="form-group">
                      <p class="py-2">Reason for Item Return</p>
                      <input type="hidden" required="required" id="product_order_id" name="product_order_id" value="<?php echo $id; ?>" />
                      <textarea required="required" name="reason" id="reason" class="form-control" placeholder="Reason for Item Return" style="max-width: 300px; height: 90px;"></textarea>
                    </div>
                            ...
                            <div class="text-left pb-3">
                              ...
                              &nbsp;
                              <button type="button" data-toggle="modal" data-target="#submit_return"  class="btn btn-primary"><i class="fa fa-undo"></i> Return</button>
                            </div>
