            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php 
                  $qc = $conn->query("select * from tbl_order o left join tbl_mode_of_payment m on o.mode_of_payment_id = m.mode_of_payment_id where o.user_id = '$user_id'") or die($conn->error);
                    ...
                    <tr>
                      ...
                      ?>
                        <td class="text-center"><?php echo ($rc['mode_of_payment_id'] == 0 ? 'Onhand Payment' : $rc['mode_of_payment']); ?>
                          <?php if ($qp->num_rows > 0 && $rc['status'] == 'Pending') { echo '<br /><span class="text-muted" style="font-size: 10px;">(Pending Payment Approval)</span>'; } ?>
                        </td>
